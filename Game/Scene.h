...
public:
	...
	void drawMenu(int choose)
	{
		drawAllWhite();
		drawNewLineAtEnd();

		cusStrcpy(20, 6, "_________                         _____                    ________             _________", 90);
		cusStrcpy(20, 7, "__  ____/____________________________(_)_____________ _    ___  __ \\___________ ______  /", 90);
		cusStrcpy(20, 8, "_  /    __  ___/  __ \\  __ \\_  ___/_  /__  __ \\_  __ `/    __  /_/ /  __ \\  __ `/  __  / ", 90);
		cusStrcpy(20, 9, "/ /___  _  /   / /_/ / /_/ /(__  )_  / _  / / /  /_/ /     _  _, _// /_/ / /_/ // /_/ /  ", 90);
		cusStrcpy(20, 10, "\\____/  /_/    \\____/\\____//____/ /_/  /_/ /_/_\\__, /      /_/ |_| \\____/\\__,_/ \\__,_/   ", 90);
		cusStrcpy(20, 11, "                                              /____/                                     ", 90);

		cusStrcpy(36, 15, "1. New Game", 11);
		cusStrcpy(36, 16, "2. Load Game", 12);
		cusStrcpy(36, 17, "3. Setting", 10);
		cusStrcpy(36, 18, "4. Quit", 7);
		...
		for (int i = 0; i < height_; ++i)
		{
			for (int j = 0; j < width_; ++j)
			{
				if (theScene_[i][j].content_ == thePrevScene_[i][j].content_ &&
					theScene_[i][j].getForeground() == thePrevScene_[i][j].getForeground() &&
					theScene_[i][j].getBackground() == thePrevScene_[i][j].getBackground())
					continue;
